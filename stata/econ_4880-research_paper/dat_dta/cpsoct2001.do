...
local dat_name "/Users/trev/Desktop/ECON 488/cps/oct01pub.dat"

cd "/Users/trev/Desktop/ECON 488/dta"
local dta_name "./cpsoct01.dta"

cd "/Users/trev/Desktop/ECON 488/dct"
local dct_name "./cpsoct01.dct"
...
label define peged   
	...
	2           "No"                            
;
label values pedegre  pedegre;
label define pedegre 
	-9          "None response (NA)"            
	-3          "Refusal"                       
	-2          "Don't know"                    
	-1          "Out of universe"               
	...
	2           "No"                            
;
label values pedegre2 pedegreb;
label define pedegreb
	-9          "None response (NA)"            
	-3          "Refusal"                       
	-2          "Don't know"                    
	-1          "Out of universe"               
	...
	2           "Associate degree -"            
	3           "Associate degree - general"    
	4           "Bachelor's degree"             
	5           "Master's,"                     
	6           "Doctorate (Ph.D.)"             
	7           "Professional degree (MD, DDS," 
	8           "Other license or certificate"  
;
label values pereasn  pereasn;
label define pereasn 
	-9          "None response (NA)"            
	-3          "Refusal"                       
	-2          "Don't know"                    
	-1          "Out of universe"               
	1           "To improve or keep up in"      
	2           "To train for new job or"       
	3           "For non-job-related reasons"   
;
label values peadteda peadteda;
label define peadteda
	-9          "None response (NA)"            
	-3          "Refusal"                       
	-2          "Don't know"                    
	-1          "Out of universe"               
	...
	2           "No"                            
;
label values peadtedb peadtedb;
label define peadtedb
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values peadtedc peadtedc;
label define peadtedc
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values peadtedd peadtedd;
label define peadtedd
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values peadtede peadtede;
label define peadtede
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values peadtedf peadtedf;
label define peadtedf
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values peadtedg peadtedg;
label define peadtedg
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
...
label define pxged   
	...
	1           "Allocated"                     
;
label values pxdegre  pxdegre;
label define pxdegre 
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxdegre2 pxdegreb;
label define pxdegreb
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxreasn  pxreasn;
label define pxreasn 
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxadteda pxadteda;
label define pxadteda
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxadtedb pxadtedb;
label define pxadtedb
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxadtedc pxadtedc;
label define pxadtedc
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxadtedd pxadtedd;
label define pxadtedd
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxadtede pxadtede;
label define pxadtede
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxadtedf pxadtedf;
label define pxadtedf
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxadtedg pxadtedg;
label define pxadtedg
	0           "Not allocated"                 
	1           "Allocated"                     
;
