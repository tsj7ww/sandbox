...
local dat_name "/Users/trev/Desktop/ECON 488/cps/oct03pub.dat"

cd "/Users/trev/Desktop/ECON 488/dta"
local dta_name "./cpsoct03.dta"

cd "/Users/trev/Desktop/ECON 488/dct"
local dct_name "./cpsoct03.dct"
...
label define pxs57l  
	...
	1           "Allocated"                     
;
label values hesc1    hesc1l; 
label define hesc1l  
	1           "Yes"                           
	2           "No"                            
;
label values hesc2    hesc2l; 
label define hesc2l  
	-1          "Out of universe"               
	1           "One"                           
	2           "Two"                           
...
label define hesc3l  
	...
	7           "Before 1998"                   
;
label values hesint1  hesint1l;
label define hesint1l
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values hesint2a hesint2a;
label define hesint2a
	-1          "Out of universe"               
	1           "A regular 'dial-up' telephone" 
	2           "mobile phone, PDA, or pager"   
	3           "A DSL Line (Digital Subscriber"
	4           "A cable modem"                 
	5           "Satellite"                     
	6           "A fixed wireless connection"   
	7           "Something else"                
;
label values hesint2b hesint2b;
label define hesint2b
	1           "Yes"                           
	2           "No"                            
;
label values hesint2c hesint2c;
label define hesint2c
	-1          "Out of universe"               
	1           "Don't need it, not interested" 
	2           "Too expensive"                 
	3           "Can use it somewhere else"     
	4           "Not available in area"         
	5           "No computer or computer"       
	6           "Privacy and security"          
	7           "Other reason (Please specify)" 
;
label values hesevr   hesevr; 
label define hesevr  
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values hesint5a hesint5a;
label define hesint5a
	-1          "Out of universe"               
	1           "Costs are too high"            
	2           "Lack of confidence or skills"  
	3           "Don't need it, not interested" 
	4           "Privacy and security concerns" 
	5           "Concern that children will"    
	6           "Have access to Internet"       
	7           "Lack of time to use the"       
	8           "Language barriers"             
	9           "No computer or computer"       
	10          "Other reason (Please specify)" 
;
label values hesint6a hesint6a;
label define hesint6a
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values hesint6b hesint6b;
label define hesint6b
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values hesint6c hesint6c;
label define hesint6c
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values hesint6d hesint6d;
label define hesint6d
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values hesint6e hesint6e;
label define hesint6e
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values hesint6f hesint6f;
label define hesint6f
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values hescon1  hescon1l;
label define hescon1l
	-9          "N/A"                           
	-3          "Ref"                           
	-2          "DK"                            
	-1          "Out of universe"               
	...
	3           "About the same"                
;
label values hescon2  hescon2l;
label define hescon2l
	-9          "N/A"                           
	-3          "Ref"                           
	-2          "DK"                            
	-1          "Out of universe"               
	...
	3           "About the same"                
;
label values prnet2   prnet2l;
label define prnet2l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values prnet3   prnet3l;
label define prnet3l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values prnet1   prnet1l;
label define prnet1l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pescs    pescs;  
label define pescs   
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pescs1   pescs1l;
label define pescs1l 
	-1          "Out of universe"               
	1           "only during school hours"      
	2           "before of after school hours"  
	3           "both"                          
;
label values pesch    pesch;  
label define pesch   
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values peschw   peschw; 
label define peschw  
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesch1   pesch1l;
label define pesch1l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesch2   pesch2l;
label define pesch2l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesch2na pesch2na;
label define pesch2na
	-1          "Out of universe"               
	1           "Through a home PC (desktop)"   
	2           "Through a portable or laptop"  
	3           "Through a TV-based Internet"   
	4           "Through a mobile (for example,"
	5           "Through a personal digital"    
	6           "Through a games machine with"  
	7           "Using any other means? (Please"
;
label values pesch2a  pesch2a;
label define pesch2a 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesch3   pesch3l;
label define pesch3l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesch4   pesch4l;
label define pesch4l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesch5   pesch5l;
label define pesch5l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesch6   pesch6l;
label define pesch6l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesch7   pesch7l;
label define pesch7l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pescw    pescw;  
label define pescw   
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pescw1   pescw1l;
label define pescw1l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pescw2   pescw2l;
label define pescw2l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pescw3   pescw3l;
label define pescw3l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pescw4   pescw4l;
label define pescw4l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pescw5   pescw5l;
label define pescw5l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pescw6   pescw6l;
label define pescw6l 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnet   pesnet; 
label define pesnet  
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetsc pesnetsc;
label define pesnetsc
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetsd pesnetsd;
label define pesnetsd
	-1          "Out of universe"               
	1           "only during school hours"      
	2           "before of after school hours"  
	3           "both"                          
;
label values pesnetsw pesnetsw;
label define pesnetsw
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetsx pesnetsx;
label define pesnetsx
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetsy pesnetsy;
label define pesnetsy
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetsz pesnetsz;
label define pesnetsz
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetsb pesnetsb;
label define pesnetsb
	-1          "Out of universe"               
	1           "At least once a day"           
	2           "At least once a week but not"  
	3           "At least once a month but not" 
	4           "Less than once a month"        
;
label values pesneta  pesneta;
label define pesneta 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetb  pesnetb;
label define pesnetb 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetd  pesnetd;
label define pesnetd 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnete  pesnete;
label define pesnete 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetf  pesnetf;
label define pesnetf 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetg  pesnetg;
label define pesnetg 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesneth  pesneth;
label define pesneth 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesneti  pesneti;
label define pesneti 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetj  pesnetj;
label define pesnetj 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetk  pesnetk;
label define pesnetk 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetl  pesnetl;
label define pesnetl 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetl1 pesnetla;
label define pesnetla
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetl2 pesnetlb;
label define pesnetlb
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetm  pesnetm;
label define pesnetm 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetn  pesnetn;
label define pesnetn 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetp  pesnetp;
label define pesnetp 
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetp1 pesnetpa;
label define pesnetpa
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetp2 pesnetpb;
label define pesnetpb
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetp3 pesnetpc;
label define pesnetpc
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values pesnetp4 pesnetpd;
label define pesnetpd
	-1          "Out of universe"               
	1           "Yes"                           
	2           "No"                            
;
label values peds1w   peds1w; 
label define peds1w  
	-9          "NA"                            
	-3          "Ref"                           
	-2          "DK"                            
...
label define peds2l  
	...
	2           "No"                            
;
label values hxsc1    hxsc1l; 
label define hxsc1l  
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsc2    hxsc2l; 
label define hxsc2l  
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsc3    hxsc3l; 
label define hxsc3l  
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint1  hxsint1l;
label define hxsint1l
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint2a hxsint2a;
label define hxsint2a
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint2b hxsint2b;
label define hxsint2b
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint2c hxsint2c;
label define hxsint2c
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsevr   hxsevr; 
label define hxsevr  
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint5a hxsint5a;
label define hxsint5a
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint6a hxsint6a;
label define hxsint6a
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint6b hxsint6b;
label define hxsint6b
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint6c hxsint6c;
label define hxsint6c
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint6d hxsint6d;
label define hxsint6d
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint6e hxsint6e;
label define hxsint6e
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint6f hxsint6f;
label define hxsint6f
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxscs    pxscs;  
label define pxscs   
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxscs1   pxscs1l;
label define pxscs1l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsch    pxsch;  
label define pxsch   
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxschw   pxschw; 
label define pxschw  
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsch1   pxsch1l;
label define pxsch1l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsch2   pxsch2l;
label define pxsch2l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hxsint2na hxsint2na;
label define hxsint2na
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsch2a  pxsch2a;
label define pxsch2a 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsch3   pxsch3l;
label define pxsch3l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsch4   pxsch4l;
label define pxsch4l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsch5   pxsch5l;
label define pxsch5l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsch6   pxsch6l;
label define pxsch6l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsch7   pxsch7l;
label define pxsch7l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxscw    pxscw;  
label define pxscw   
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxscw1   pxscw1l;
label define pxscw1l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxscw2   pxscw2l;
label define pxscw2l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxscw3   pxscw3l;
label define pxscw3l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxscw4   pxscw4l;
label define pxscw4l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxscw5   pxscw5l;
label define pxscw5l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxscw6   pxscw6l;
label define pxscw6l 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnet   pxsnet; 
label define pxsnet  
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetsc pxsnetsc;
label define pxsnetsc
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetsd pxsnetsd;
label define pxsnetsd
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetsw pxsnetsw;
label define pxsnetsw
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetsx pxsnetsx;
label define pxsnetsx
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetsy pxsnetsy;
label define pxsnetsy
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetsz pxsnetsz;
label define pxsnetsz
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetsb pxsnetsb;
label define pxsnetsb
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsneta  pxsneta;
label define pxsneta 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetb  pxsnetb;
label define pxsnetb 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetd  pxsnetd;
label define pxsnetd 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnete  pxsnete;
label define pxsnete 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetf  pxsnetf;
label define pxsnetf 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetg  pxsnetg;
label define pxsnetg 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsneth  pxsneth;
label define pxsneth 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsneti  pxsneti;
label define pxsneti 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetj  pxsnetj;
label define pxsnetj 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetk  pxsnetk;
label define pxsnetk 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetl  pxsnetl;
label define pxsnetl 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetl1 pxsnetla;
label define pxsnetla
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetl2 pxsnetlb;
label define pxsnetlb
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetm  pxsnetm;
label define pxsnetm 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetn  pxsnetn;
label define pxsnetn 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetp  pxsnetp;
label define pxsnetp 
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetp1 pxsnetpa;
label define pxsnetpa
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetp2 pxsnetpb;
label define pxsnetpb
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetp3 pxsnetpc;
label define pxsnetpc
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values pxsnetp4 pxsnetpd;
label define pxsnetpd
	-1          "Not in universe"               
	0           "Not allocated"                 
	1           "Allocated"                     
;
label values hrtelr11 hrtelr1a;
label define hrtelr1a
	-1          "Not in universe"               
	1           "Can use it somewhere else"     
	2           "Use a wireless phone outside"  
	3           "Use a pager instead"           
	4           "Cost, too expensive"           
	5           "Problems with service provider"
	6           "Cultural, language, or"        
	7           "Concern about how children use"
	8           "Don't want it"                 
	9           "Reasons related to moving"     
	10          "Harassing telephone calls"     
	11          "Other"                         
;
label values hrtelr21 hrtelr2a;
label define hrtelr2a
	-1          "Not in universe"               
	1           "Can use it somewhere else"     
	2           "Use a wireless phone outside"  
	3           "Use a pager instead"           
	...
	7           "Concern about how children use"
	8           "Don't want it"                 
	9           "Phone service not available in"
	10          "Other"                         
;
